...
import org.autojs.autojs.service.VoiceAssistantService
...
open class DrawerFragment : Fragment() {
    ...
    private lateinit var mVoiceAssistantServiceItem: DrawerMenuToggleableItem
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mVoiceAssistantServiceItem = DrawerMenuToggleableItem(
            VoiceAssistantService(mContext),
            R.drawable.ic_assistant_black_48dp,
            R.string.text_voice_assistant_service,
            R.string.text_voice_assistant_service_description,
            R.string.key_voice_assistant_service,
        )
    ...
    @Subscribe
    @Suppress("unused", "UNUSED_PARAMETER")
    fun onVoiceInteractionServiceStateChanged(event: Event.VoiceInteractionServiceStateChangedEvent) {
        mVoiceAssistantServiceItem.sync()
    }
    ...
    companion object {
        ...
        class Event {
            ...
            interface VoiceInteractionServiceStateChangedEvent
